...
export interface Contact { id:string; email:string; firstName?:string; lastName?:string; company?:string; customFields?:Record<string,any>; tags:string[]; status:ContactStatus; bounceReason?:string; createdAt:string; updatedAt:string; }
