...
import { LayoutDashboard, Send, Megaphone, MailCheck, Users, ShieldAlert, Server, BarChart3, Terminal, Settings, FileCode2, LogOut, Webhook, UserCog } from 'lucide-react';
...
export const Sidebar:React.FC<SidebarProps>=({currentTab,onSelectTab,kumoStatus='unknown',sesStatus='unknown',queueCount=0,user,onLogout})=>{
 const groups=[
  ...
  {label:'System',items:[['senders','Infrastructure',Server],['settings','API & Webhooks',Webhook],['logs','Users & Roles',UserCog],]}
 ] as const;
