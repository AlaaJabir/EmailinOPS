...
const statusClass=(s?:string)=>({healthy:'text-emerald-400',degraded:'text-amber-400',offline:'text-red-400',unknown:'text-zinc-500'}[normalizeStatus(s)]);
export const Sidebar:React.FC<SidebarProps>=({currentTab,onSelectTab,kumoStatus='unknown',sesStatus='unknown',queueCount=0,user,onLogout})=>{
 const groups=[
  ...
  {label:'Send',items:[['campaigns','Campaigns',Megaphone],['templates','Templates',FileCode2],['send','Send Email',Send],['messages','Messages',MailCheck]]},
  {label:'Data & Compliance',items:[['contacts','Contacts',Users],['suppression','Suppression List',ShieldAlert]]},
